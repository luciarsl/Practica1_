...
public class Properties {
    ...
    public Properties(int ID_LINIA, int CODI_LINIA, String NOM_LINIA, String DESC_LINIA, String ORIGEN_LINIA, String DESTI_LINIA, int NUM_PAQUETS, int ID_OPERADOR, String NOM_OPERADOR, String NOM_TIPUS_TRANSPORT, int CODI_FAMILIA, String NOM_FAMILIA, int ORDRE_FAMILIA, int ORDRE_LINIA, String CODI_TIPUS_CALENDARI, String NOM_TIPUS_CALENDARI, String DATA, String COLOR_LINIA, String COLOR_AUX_LINIA, String COLOR_TEXT_LINIA, String CODI_OPERADOR, int ID_FAMILIA, int ID_TIPUS_TRANSPORT) {
        ...
        this.CODI_OPERADOR = CODI_OPERADOR;
        this.ID_FAMILIA = ID_FAMILIA;
        this.ID_TIPUS_TRANSPORT = ID_TIPUS_TRANSPORT;
    }
    ...
    public String getCODIOPERADOR() {
        return CODI_OPERADOR;
    }

    public void setCODIOPERADOR(String CODI_OPERADOR) {
        this.CODI_OPERADOR = CODI_OPERADOR;
    }
    ...
    public int getIDTIPUSTRANSPORT() {
        return ID_TIPUS_TRANSPORT;
    }

    public void setIDTIPUSTRANSPORT(int ID_TIPUS_TRANSPORT) {
        this.ID_TIPUS_TRANSPORT = ID_TIPUS_TRANSPORT;
    }
