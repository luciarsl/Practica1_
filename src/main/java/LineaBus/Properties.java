...
public class Properties {
    ...
    @Expose
    private String cODIOPERADOR;
    @SerializedName("ID_FAMILIA")
    @Expose
    private int iDFAMILIA;
    @SerializedName("ID_TIPUS_TRANSPORT")
    @Expose
    private int iDTIPUSTRANSPORT;
    ...
    public Properties(int iDLINIA, int cODILINIA, String nOMLINIA, String dESCLINIA, String oRIGENLINIA, String dESTILINIA, int nUMPAQUETS, int iDOPERADOR, String nOMOPERADOR, String nOMTIPUSTRANSPORT, int cODIFAMILIA, String nOMFAMILIA, int oRDREFAMILIA, int oRDRELINIA, String cODITIPUSCALENDARI, String nOMTIPUSCALENDARI, String dATA, String cOLORLINIA, String cOLORAUXLINIA, String cOLORTEXTLINIA, String cODIOPERADOR, int iDFAMILIA, int iDTIPUSTRANSPORT) {
        ...
        this.cODIOPERADOR = cODIOPERADOR;
        this.iDFAMILIA = iDFAMILIA;
        this.iDTIPUSTRANSPORT = iDTIPUSTRANSPORT;
    }
    ...
    public String getCODIOPERADOR() {
        return cODIOPERADOR;
    }

    public void setCODIOPERADOR(String cODIOPERADOR) {
        this.cODIOPERADOR = cODIOPERADOR;
    }
    ...
    public int getIDTIPUSTRANSPORT() {
        return iDTIPUSTRANSPORT;
    }

    public void setIDTIPUSTRANSPORT(int iDTIPUSTRANSPORT) {
        this.iDTIPUSTRANSPORT = iDTIPUSTRANSPORT;
    }
